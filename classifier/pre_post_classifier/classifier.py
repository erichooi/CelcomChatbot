...
with jsonlines.open("data/devTest.jsonl", "r") as reader:
    for line in reader:
...
cprint("Report", "red")
print("-------------------------------------------------------------------\n")
cprint(classification_report(y_test, predicted, target_names=target_names), "blue")
...
while True:
    ...
    if write_to_result == "yes":
        with open("result.txt", "a") as f:
            ...
            f.write("Report\n")
            f.write("------------\n")
            f.write(classification_report(y_test, predicted, target_names=target_names))
            f.write("\n")
            f.write("--------------------------------------------------------------------------------------" + "\n")
            break
